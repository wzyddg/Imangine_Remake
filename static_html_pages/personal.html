    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row" style="text-align: center;padding-top: 30px;padding-bottom: 40px;">
                        <img src="images/prof.jpg" />
                    </div>
                    <div class="row">
                        <div class="col-md-5 pinfo-1">
                            <label>User Id</label>
                            <br />
                            <label>Name</label>
                            <br />
                        ...
                        <div class="col-md-4 pinfo-2">
                            <label>Spongebob@google.com</label>
                            <br />
                            <label>Sponge Bob</label>
                    ...
                    <div class="row" style="text-align: center;padding-bottom: 10px;">
                        <a href="blog-my-mypic.html"><button class="mypage">My Page</button></a>
                    </div>
                </div>
            </div>
        </div>
